...
$bot_id = "1569691184"; //ايدي البوت

$admmm = "5413631898"; //ايدي المطور

$tbbots = "AhMeD"; //معرف المطور بدون @

$API_KEY = "1569691184:AAEqxzQn5D0ZWY2prJ8Gaq3g5zhbGhT3gqI";
...
'disable_web_page_preview'=>true,
        ...
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'• قناة السورس •','url'=>'https://t.me/xXStrem']],
               ]
        ])
    ]);
}
...
الكليشة الحالية 
👨‍✈️❉ اهلا بك عزيزي في سورس بدون حقوق
💢❉ السورس الاول بلغه php
💢❉ السورس الاول اكتمالا في اليمن والدول العربيه
💢❉ لايحتاج سرفرات او VPS
💢❉ سريع جدا ومميزات خياليه
••┉┉┉┉┉┉┉┉┉┉┉┉┉•• 
💢❉ قم بمراسله المطور لصنع بوت مدفوع خاص بك › @AhMeD ✅
📮✣ لصنع بوتك مجاني من مصنع بوتات بدون حقوق ‹ @r5hbot › 👨🏽‍💻
#ملاحظة :/ لاتضيف اوامر جديدة من عندك
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
...
$fast = array('• اسرع واحد يرسل » { احمد }','• اسرع واحد يرسل » { محمد }','• اسرع واحد يرسل » { قناة }','• اسرع واحد يرسل » { بوت بدون حقوق }','• اسرع واحد يرسل » { رمضان }','• اسرع واحد يرسل » { تيم كايدو }','• اسرع واحد يرسل » { العبسي }','• اسرع واحد يرسل » { تلفون }','• اسرع واحد يرسل » { مطبخ }','• اسرع واحد يرسل » { اليمن }','• اسرع واحد يرسل » { سوريا }','• اسرع واحد يرسل » { العراق }','• اسرع واحد يرسل » { السعوديه }','• اسرع واحد يرسل » { مصر }','• اسرع واحد يرسل » { السودان }');
...
if(in_array($chat_id,$game1) and $text == 'العبسي' or $text == 'احمد'  or $text == 'اليمن'  or $text == 'مصر'  or $text == 'السودان'  or $text == 'سوريا' or  $text == 'العراق' or $text == 'رمضان' or $text == 'تيم كايدو' or $text == 'تلفون' or $text == 'بوت بدون حقوق' or $text == 'قناة' or $text == 'محمد' or $text == 'مطبخ'){
if($level == "gamew"){
$game['game'][$chat_id][$from_id] = ($game['game'][$chat_id][$from_id]+1);
file_put_contents('game.json', json_encode($game));
file_put_contents("game/$chat_id/game.txt","");
...
'مرحبا'=>'[مـراحـݕ ياۿـلا┋ 💖😻](https://t.me/xXStrem)',
'هلو'=>'[هــلؤﯙؤات ﺣﻳـاﺗـﻲ 🌸❓❓](https://t.me/xXStrem)',
...
'🙄' => 'نزل عيونك لتنحول 😐😹😹' ,
 'وين القناة'  =>  'قناة جديدنا @xXStrem',
'قناتي' => 'قناة البوتات @xXStrem',
'احبك' => 'واني هم حبي',
...
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>'','url'=>"https://telegram.me/xXStrem"]
              ] 
              ],
        ])
            ]);
